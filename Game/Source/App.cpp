...
void App::FinishUpdate()
{
	...
	sprintf_s(title, 256, "%s: FPS: %i | Av. FPS: %.2f | Last-frame MS: %.3f | Vsync: %s ",
		gameTitle.GetString(), framesPerSecond, averageFps, dt, /*secondsSinceStartup, frameCount,*/ formatBool(app->render->vsync));
